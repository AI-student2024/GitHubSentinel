// src/HackerNewsDailyReportGenerator.js

import React, { useState } from 'react';
import axios from 'axios';

function HackerNewsDailyReportGenerator() {
  ...
  const generateReport = () => {
    setError('');
    setLoading(true);
    axios.post('/generate_hn_daily_report', {
      date,
...
export default HackerNewsDailyReportGenerator;
